...
public class KThread {
     ...
     */
    private ThreadQueue waitForJoinQueue = null;
     ...
     */
    public KThread() {
        waitForJoinQueue = ThreadedKernel.scheduler.newThreadQueue(true);
